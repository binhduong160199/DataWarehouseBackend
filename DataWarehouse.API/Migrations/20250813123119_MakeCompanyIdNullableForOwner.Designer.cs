...
namespace DataWarehouse.API.Migrations
{
    ...
    [Migration("20250813123119_MakeCompanyIdNullableForOwner")]
    partial class MakeCompanyIdNullableForOwner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataWarehouse.Models.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DataWarehouse.Models.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DataWarehouse.Models.Entities.User", b =>
                {
                    b.HasOne("DataWarehouse.Models.Entities.Company", "Company")
                        .WithMany("Users")
